    ...
    <x-slot name="slot">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card card-icon mb-4">
                            <div class="card-body text-center">
                                ...
                                @if($patientx->phoneNo)
                                <a href="{{route('user.notify',$patientx->id)}}">{{$patientx->name}}, No Telp :
                                    {{$patientx->phoneNo}}, Address : {{$patientx->address}}</a><br>
                                @endif
                                @endforeach
                            </div>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="card-title">Rekapan Bulan Lalu - {{ Carbon\Carbon::now()->subMonth()->format("M") }}
                        </div>
                        <div class="row">
