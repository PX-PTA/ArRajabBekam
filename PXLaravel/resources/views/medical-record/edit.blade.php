                                            ...
                                            <div class="row">
                                                <div class="col-md-3 form-group mb-3">
                                                    ...
                                                    <input type="number" min="0" class="form-control" id="no" name="no"
                                                        placeholder="Input Nomor" required="required"  value="{{$medicalRecord->id}}" >
                                                </div>
                                                ...
                                                <div class="col-md-3 form-group mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input  type="date" id="picker"
                                                            ...
                                                            name="date"  value="{{$medicalRecord->date}}">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row ">
                                                        <div class="col-md-6 form-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="sys" name="sys"
                                                                placeholder="Input Sys" value="{{$medicalRecord->blood_pressure_sys}}">
                                                        </div>
                                                        <div class="col-md-6 form-group mb-3">
                                                            <label for="firstName1">Dia</label>
                                                            <input type="text" class="form-control" id="dia" name="dia"
                                                                placeholder="Input Dia" value="{{$medicalRecord->blood_pressure_dia}}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-md-12 form-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="terapist"
                                                                name="terapis" placeholder="Input Terapist" value="{{$medicalRecord->terapis}}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
